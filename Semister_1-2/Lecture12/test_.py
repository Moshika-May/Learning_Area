...
glo_game_state = create_game_state("banana", 6)
glo_result = {"won": False, "secret_word": "banana", "remaining_attempts": 0, "used_letters": ["x", "y", "a"]}

print(display_game_result(glo_result))