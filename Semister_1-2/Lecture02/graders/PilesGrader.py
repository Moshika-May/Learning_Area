...
def grade(student_file):
    """Grade Piles solutions.

    Expectations:
      - All beepers are picked up (no beepers remain in the world).
    ...
    # Check that all beepers were picked up (no beepers remain)
    ...
    if score == 100:
        return 100, ["Correct: all beepers picked up and Karel at (7,1) facing east"]
